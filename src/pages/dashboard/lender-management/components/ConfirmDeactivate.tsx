...
export const ConfirmDeactivate = (props:confirmDeactivateProps) => {
    return (
        <div className=''>
            ...
            <h4 className='text-lg  mt-3 mb-2'> Deactivate Company</h4>
            <p className='text-darkGrey font-[400] text-[15px]'>Are you sure you want to deactivate this company? This action cannot be undone.</p>
